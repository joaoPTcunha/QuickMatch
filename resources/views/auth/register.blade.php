    ...
    <div class="bg-gray-200 p-10 rounded-lg shadow-lg w-full max-w-sm transition-transform transform hover:scale-105">
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="mt-4 text-center">
                <a href="{{route('google-auth')}}" type="button" class="mt-2 w-full bg-white text-black py-2 rounded-md hover:bg-gray-200 transition duration-300 flex items-center justify-center">
                    <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="32" height="26" viewBox="0 0 48 48">

...
<body class="flex flex-col min-h-screen">
    <div class="flex-grow flex items-center justify-center bg-white overflow-hidden">
        <div class="bg-gray-200 p-10 rounded-lg shadow-lg w-full max-w-sm transition-transform transform hover:scale-105">
            ...
            <form method="POST" action="{{ route('register') }}">
                ...
                <div class="mt-4 text-center">
                    <a href="{{route('google-auth')}}" class="w-full bg-white text-black py-2 rounded-md hover:bg-gray-200 transition duration-300 flex items-center justify-center">

...
<body class="flex flex-col min-h-screen bg-gray-100">
    ...
    <div id="locationModal" class="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 hidden">
        <div class="bg-white p-6 sm:p-8 lg:p-10 rounded-lg shadow-lg w-full max-w-3xl">
            ...
            <div id="locationName" class="block w-full px-4 py-2 border rounded-lg shadow focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm sm:text-base break-words min-h-[1rem] overflow-y-auto max-h-24"></div>

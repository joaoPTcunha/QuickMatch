<main class="container mx-auto text-center py-16 flex-grow">
    ...
    <a href="#" class="bg-purple-500 text-white px-4 py-2 rounded hover:bg-purple-600 transition duration-300 shadow-lg">Começar agora</a>
    ...
    <div class="mt-16">
        ...
        <a href="{{url('/register')}}" class="bg-purple-500 text-white px-4 py-2 rounded hover:bg-purple-600 transition duration-300 shadow-lg" >Registe-se!</a>
        </div>
</main>
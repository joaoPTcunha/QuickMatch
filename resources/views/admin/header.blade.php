<header class="bg-gray-200 py-4 mb-8">
    <div class="container mx-auto flex justify-between items-center">
        ...
        <nav class="hidden md:flex md:flex-row md:space-x-3 md:items-center w-full md:w-auto">
            ...
            <a href="{{ url('/contact') }}" class="text-gray-700 hover:text-gray-900 px-2 py-2">Gestão de Utilizadores</a>
    ...
    <div class="md:hidden">
        <div id="menu-items" class="hidden flex-col space-y-2 p-4 bg-gray-200">
            <a href="{{ url('/field') }}" class="block text-gray-700 hover:text-gray-900 px-2 py-2 w-full">Estatisticas</a>
            <a href="{{ url('/spinwheel') }}" class="block text-gray-700 hover:text-gray-900 px-2 py-2 w-full">Campos</a>
            <a href="{{ url('/contact') }}" class="block text-gray-700 hover:text-gray-900 px-2 py-2 w-full">Gestão de Utilizadores</a>
            <a href="{{ url('/contact') }}" class="block text-gray-700 hover:text-gray-900 px-2 py-2 w-full">Suporte ao Cliente</a>
            <a href="{{ url('/contact') }}" class="block text-gray-700 hover:text-gray-900 px-2 py-2 w-full">Manutenção</a>
